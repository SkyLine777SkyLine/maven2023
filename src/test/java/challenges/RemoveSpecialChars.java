...
//		bankBalanceStr = bankBalanceStr.replace("$", "");
//		System.out.println(bankBalanceStr);
//		double bankBlance = Double.parseDouble(bankBalanceStr);
		...
		System.out.println(Character.isAlphabetic(ageInt));	
	}
public static double removeDollarSign(String s) {
	s = s.replace("$", "");
	return Double.parseDouble(s);//wrapped classes primitive type become object type
